...
static final String projectFilesPath = "D:\\Yash\\FileIo"; 
static int choice = 0;
...
System.out.println("\t\tDeveloper Details: Yash Kantale");
System.out.println("*******************************************");
}
...
public static void createFiles() { int linesCount = 0;
// Using Try-Catch Block 
try {
...
if (filenames.contains(fileName)) { System.out.println("File is Available");
} else {
